...
import {Bell, Brain, ChevronLeft, ChevronRight, LogOut, Menu, MessageCircle, Plus, Send, User} from 'lucide-react';
...
function Dashboard() {
    ...
    // Updated: When selecting a channel on mobile, hide the sidebar overlay.
    ...
    return (
        <div className="h-screen flex flex-col overflow-hidden bg-gray-100">
          ...
          `}
                >
                    <div
                        className={`p-4 border-b border-gray-200 flex justify-between items-center ${sidebarCollapsed ? 'justify-center' : ''}`}>
                    ...
                    <div className="flex-grow overflow-y-auto">
                        {loading ? (
                            <div className={`p-4 text-center text-gray-500 ${sidebarCollapsed ? 'hidden' : ''}`}>Loading
                                chats...</div>
                        ) : channels.length === 0 ? (
                                    ...
                                    <li key={channel.id}>
                                        ...
                                        >
                                            <MessageCircle size={20}
                                                           className={`${sidebarCollapsed ? '' : 'mr-2'} text-gray-500 flex-shrink-0`}/>
                                            {!sidebarCollapsed && (
                ...
                {/* Main Chat Area */}
                <div
                    className={`flex-1 flex flex-col transition-all duration-300 ease-in-out ${sidebarCollapsed ? 'md:w-[calc(100%-4rem)]' : 'md:w-3/4'}`}>
                    {selectedChannel ? (
                        <>
                            {/* Messages */}
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {message.user?.id === currentUser.userId ? (
                                                        ...
                                                        <div
                                                            className="markdown-content prose prose-sm max-w-none dark:prose-invert overflow-auto">
